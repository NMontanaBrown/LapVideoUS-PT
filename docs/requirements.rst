...
===============================================
Requirements for LapVideoUS-PT
===============================================

This is the software requirements file for LapVideoUS-PT, part of the
SNAPPY project. The requirements listed below should define
what LapVideoUS-PT does. Each requirement can be matched to a unit test that
